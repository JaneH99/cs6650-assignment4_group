...
public class DataSourceConfig {
  ...
  public DatabaseWriter databaseWriter1(
    ...
    log.info("Creating databaseWriter1 (rooms 1-10) with threads={} batchSize={} flushInterval={}ms",
        writerThreads, batchSize, flushIntervalMs);
    return new DatabaseWriter(buffer1, repository1, writerThreads, batchSize,
        flushIntervalMs, maxRetries, dbMetricsIntervalSec);
  }
  ...
  public DatabaseWriter databaseWriter2(
    ...
    log.info("Creating databaseWriter2 (rooms 11-20) with threads={} batchSize={} flushInterval={}ms",
        writerThreads, batchSize, flushIntervalMs);
    return new DatabaseWriter(buffer2, repository2, writerThreads, batchSize,
        flushIntervalMs, maxRetries, dbMetricsIntervalSec);
  }
